<template>
    <div class="__vev_calendar-wrapper">
        <cal-panel :events="events" :calendar="calendarOptions" @cur-day-changed="handleChangeCurDay" @month-change="monthChange">
        </cal-panel>
        <cal-events :dayEvents="selectdDayEvents" :locale="calendarOptions.options.locale" :color="calendarOptions.options.color">
...
export default {
    ...
    methods: {
        handleChangeCurDay(date) {
            ...
            this.$emit("change-day", this.selectdDayEvents.date);
        },
        monthChange() {
            this.selectdDayEvents = {
                date: 'all',
        ...
        emitMonth() {
            this.$emit("change-month", {
                curMonth: this.calendarParams.curMonth,
                curYear: this.calendarParams.curYear,
            });
        }
    },
    watch: {
