...
var DealContentsFutures = React.createClass({
  ...
  render: function () {
    var creatContents = function (content) {
      ...
      var num = floatToFixed(content['113'],0);
      //开平仓标志117,1平仓，0开仓
      //买卖类别112,1卖出c4，0买入c3
      if (content['112'] == 0 && content['117'] == 0) {
        direction = React.createElement(
      ...
      if (this.props.history) {
        return React.createElement(
          ...
          React.createElement(
            'div',
            { className: 'row hide cfgHideBox', id: 'hideBox' + index },
              this.props.hides&&this.props.hides.indexOf(entrustTime)!=-1?null:React.createElement(
                'div',
                { className: 'col-xs-6' },
                React.createElement(
                  'span',
    ...
    var creatContents = function (content) {
      ...
      if (isNaN(content['profit'])) {
        pl = React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'span',
              { className: 'a1', id: "profit_"+content['code'] },
              content['profit']
            )
          )
        );
        ...
        if (content['profit'] > 0) {
          pl = React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'span',
                { className: 'a3', id: "profit_"+content['code'] },
                '+' + content['profit']
              )
            )
          );
          ...
          pl = React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                'span',
                { className: 'a4' , id: "profit_"+content['code']},
                content['profit']
              )
            )
          );
      ...
      if (isNaN(content['price'])) {
        price = React.createElement(
          ...
          React.createElement(
            'span',
            { className: 'c1',id: "price"+content['code'] },
            content['price']
          )
        );
      } else {
...
var RecContentsFutures = React.createClass({
  ...
  render: function () {
    var creatContents = function (content) {
            ...
            if(content['211'].length >= 4){
                styles = {marginLeft: '10', lineHeight: '20px'}
            }else{
              styles = {
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'a',
              { className: 'btn btn-default', style: path, href: 'pobo:uncheck=0&index-add.html?pageId=900005' },
              React.createElement(
                'p',
                null,
                '添加'
