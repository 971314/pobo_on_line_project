            ...
            <div class="setOut">
                <ul>
                    ...
                    <li v-if="initPrice">
                        ...
                        <div class="priceTwo"></div>
                        <div class="priceThree">
                            <input  type="text" v-model="editQueryInfo.valueEdit" placeholder="价格"/>
                        </div>
                    </li>
                    <li v-else="initTime">
                    ...
                    <li>
                        ...
                        <span class="trustSpanOne" data-toggle="modal" data-target="#priceInfoDialog">
                            类型
                        </span>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="conTwo">
                            <span class="market"><input type="text" class="inputText"   v-model="editQueryInfo.VolumeEdit"/></span>
                        </div>
                    </li>
                </ul>
            </div>
