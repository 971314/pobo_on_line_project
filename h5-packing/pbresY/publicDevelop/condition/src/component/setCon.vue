            ...
            <div class="setOut">
                <ul>
                    ...
                    <li v-if="initPrice">
                        ...
                        <div class="priceTwo"></div>
                        <div class="priceThree">
                            <input  type="text" onkeyup="value=value.replace(/[^\.\d]/g,'')"   placeholder="价格" v-model="setDataObj.tjPriceValue"/>
                        </div>
                    </li>
                    <li v-else="initTime">
                    ...
                    <li>
                        ...
                        <div class="conTwo">
                        <span class="market">
                             <input type="text" onkeyup="value=value.replace(/[^\.\d]/g,'')"   class="inputText"  v-model="setDataObj.Volume"/>
                        </span>
                        </div>
                    </li>
                </ul>
