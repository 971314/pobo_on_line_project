...
var testUserId = "10019";//云交易userId;
var option = {
    callbacks: [
...
if(stopLessType == 0 || stopLessType == 3){
    ...
    new Vue({
        ...
        watch:{
            //非空判断
            'stopFiledObj.filedPrice':function(newVal,oldVal){
            ...
            'stopFiledObj.stopPrice':function(newVal,oldVal){
        ...
        methods:{
            ...
            btnConfirmClick:function(){
                ...
                //止损止盈条件参数
                data.ConditionList[0].PositionStop.StopLossPrice = parseInt(_this.stopFiledObj.stopPrice);//止损价
                data.ConditionList[0].PositionStop.StopProfitPrice =parseInt(_this.stopFiledObj.filedPrice);//止盈价
    ...
    new Vue({
        ...
        methods:{
            addInfo:function(){
                ...
                if(window.pbE){
                    $("#nativeUrl").attr('href','pobo:uncheck=1&pageId=900005&url=condition/component/condition-set-sl.html?type=3')
