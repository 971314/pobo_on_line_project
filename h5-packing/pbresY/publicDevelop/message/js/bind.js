(function(){
    ...
    function reload() {
        if($("#bindLi").length == 0) {
            $(el).append('<li id="bindLi"><a href="../../message/component/binds.html">账户关联<span class="pull-right"><span id="binding"></span><img class="more" src="../images/more.png"></span></a></li>');
        }
        if(pbMSG)      
            isMSGReady(function(){
