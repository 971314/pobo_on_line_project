...
define(function(require, exports, module) {
    $.config = {
        ...
        seaBaseUrl: "../main/",
        //项目名，默认为project
        projName: "information", //一般为“project”，对应的项目目录名字
        //项目的css目录
        cssPathName: "css",
        //项目的images目录
        ...
        viewsPathName: "views",
        //壳子文件scripts文件路径
        shellScriptPath: "information/shellFunction/msgFunction.js",
        /**
         * 后端接口返回过滤
         */
        executeFilter: {
        ...
        pAlias: {
            "common": "information/scripts/common/common.js", //框架公共JS
            "commonExt": "information/scripts/common/commonExt.js", //框架公共JS
            "constants": "information/scripts/common/constants", //常量
            "nativePluginService": "information/shellFunction/nativePluginService.js", //和壳子通讯service
            "msgFunction":"information/shellFunction/msgFunction.js",
            ...
            "vIscroll": "2.0.0/js/plugins/iscroll/scripts/vIscroll.js", //iscroll
            "businessUtil":"information/scripts/common/businessUtil.js",
            "commService":"information/services/commService.js",
            "informationService":"information/services/informationService.js"
        },
        //登录检测(一个模块里面登录只要一个)
        loginCheck: {
            ...
            "pageFilters": [
                ['information/views/index.html', 'information/views/index'],
                ['information/*']
            ], //过滤的pageCode,可以绕过登录
        ...
        global: {
            ...
            /****************************生产环境 begin****************************/
             "serverPath": "http://124.74.247.149:18080/servlet/json",
           "imagePath": "http://124.74.247.149:18080/servlet/Image", //生成图片验证码
            /****************************生产环境  end*****************************/

            /****************************申万测试环境  begin********************************/
            // "serverPath":"http://222.66.235.70:41402/servlet/json" ,//本地环境开发后台接口地址
