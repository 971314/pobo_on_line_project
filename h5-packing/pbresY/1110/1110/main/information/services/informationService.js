 ...
 * 手机前端service层调用接口
 **/
define('information/services/informationService.js', function(require, exports, module) {
    //构造方法
    ...
    /********************************公共代码部分********************************/
    InformationService.prototype.commonInvoke = function(reqParamVo, callback, ctrlParam) {
     ...
     * @return 接口的响应数据
     */
    InformationService.prototype.getAnnouncementDetail = function(param, callback, ctrlParam) {
        var paraMap = param || {};
        paraMap["funcNo"] = "1109803";
     ...
     * @return 接口的响应数据
     */
    InformationService.prototype.getAnnouncement = function(param, callback, ctrlParam) {
        var paraMap = param || {};
     ...
     * 释放操作
     */
    InformationService.prototype.destroy = function() {
