...
define(function(require, exports, module) {
	$.config = {
		 ...
		 * 扩展全局配置
		 * */
		globalExtend: function globalExtend() {
			//弹出框架不关闭前一个，默认是关闭
			...
			$.hideIndicatorHtml = function() {
				$.hidePreloader();
			};
			$.showIndicatorHtml = function() {
				$.showPreloader();
				$(" .modal-title").text("请等待...");
			};
...
//			$.hidePreloader = function() {};
		...
		//项目名，默认为project
		projName: "futures", //一般为“project”，对应的项目目录名字
		//项目的css目录
		cssPathName: "css",
		//项目的images目录
		...
		viewsPathName: "views",
		//壳子文件scripts文件路径
		shellScriptPath: "futures/shellFunction/msgFunction.js",
		/**
		 * 后端接口返回过滤
		 */
		executeFilter: {
			executeFilterFunc: function executeFilterFunc(data) {
		...
		pAlias: {
			"common": "futures/scripts/common/common.js", //框架公共JS
			"commonExt": "futures/scripts/common/commonExt.js", //框架公共JS
			"constants": "futures/scripts/common/constants", //常量
			"nativePluginService": "futures/shellFunction/nativePluginService.js", //和壳子通讯service
			"validatorUtils": "2.0.0/js/plugins/validator/scripts/validatorUtils.js", //验证类
			"rsa": "2.0.0/js/plugins/endecrypt/scripts/rsa.js",
			"endecryptUtils": "2.0.0/js/plugins/endecrypt/scripts/endecryptUtils.js",
			"userService": "futures/services/userService.js",
			"commService": "futures/services/commService.js",
			"uploadImg": "futures/scripts/common/compts/uploadImg.js", //图片上传插件
			"makeThumb": "futures/scripts/common/plugins/imgcompress/scripts/jquery.make-thumb.js",
			"index":"futures/scripts/userInfo/index.js"
		},
		//登录检测(一个模块里面登录只要一个)
		loginCheck: {
			...
			"pageFilters": [
				['futures/views/index.html', 'futures/views/index'],
				['futures/*']
			], //过滤的pageCode,可以绕过登录
			"checkFunc": function checkFunc(url, noAnimation, replace, reload, param, pagecode, prePageCode, _callback, direct) {
				return true;
				//常规登录判断
			}
		},
		...
		global: {
			...
			// "domain": "http://222.66.235.70:41402",
			// "imagePath": "http://222.66.235.70:41402/servlet/Image",
			// "UploadImage": "http://222.66.235.70:41402/servlet/UploadImage"
			/******************生产地址***********************************/
			"serverPath": "http://124.74.247.149:18080/servlet/json", //开发后台接口地址
			"domain": "http://124.74.247.149:18080",
			"imagePath": "http://124.74.247.149:18080/servlet/Image",
			"UploadImage": "http://124.74.247.149:18080/servlet/UploadImage"
		...
		ajaxTimeout: {
			time: 30,
			//请求超时处理方法
			ajaxTimeoutFunc: function ajaxTimeoutFunc(xhr, textStatus, errorMessage) {
				$.alert('网络超时');
			},
			//断网，跨域或者网络请求错误等
			execErrorFunc: function execErrorFunc(xhr, textStatus, errorMessage) {
