                            ...
                            for(var i = 0;i < data.length;i++){//最新价
                                if(_this.editQueryInfo.selectContractName != '选择期货合约'){
                                    if(data[i][10] == nameCode){
                                        ...
                                        if(data[i][31]){
                                            downPrice = pbUtils.decimalDecPrice(decimal,data[i][31]/priceMulriple);//跌停价
                                        }
...
//                    }
                    ...
                    if (dataValue.OrderAction.SmartOrder.Order.Direction == 1) {//卖
                        ...
                        //根据当前合约和买卖方向从持仓里面再次查下可平
                        _this.getCanBuy(_this.editQueryInfo.HYDM,_this.editQueryInfo.contractEditCode,1,null);
                    }
                    //开平标识
                    //开仓
                ...
                selectContractClick: function (name, market, code) {
                    ...
                    if(window.pbE){
                        ...
                        if(tradeWT){
                            ...
                            _this.editQueryInfo.HYDM = data.WTMarket;//合约市场
                            _this.editQueryInfo.contractEditCode = data.WTCode;//合约品种
                    ...
                    if (_this.editQueryInfo.selectContractName &&  _this.editQueryInfo.priceNameEdit ) {
                        if (window.pbE) {
                            ...
                            var data = {
                                ...
                                117:_this.editQueryInfo.OffsetFlagEdit+'',//开平仓标志
                                119:'1',//投保标志
                                52:gdZH,//股东账号
                                125:'0',//期权备兑标志
                                161:xwh,//席位号
