...
// this needs to be lazy-evaled because vue-dl may be required before
// vue-dl-server-renderer can set VUE_ENV
    var _isServer;
    var isServerRendering = function () {
        if (_isServer === undefined) {
            /* istanbul ignore if */
            if (!inBrowser && typeof global !== 'undefined') {
                // detect presence of vue-dl-server-renderer and avoid
...
// on their elm reference.
    ...
    function createComponent(Ctor,
        ...
        var vnode = new VNode(
            ("vue-dl-component-" + (Ctor.cid) + (name ? ("-" + name) : '')),
...
// without getting yelled at by flow
    ...
    function initRender(vm) {
        ...
        // normalization is always applied for the 1998 version, used in
...
// contain child elements.
    ...
    function createPatchFunction(backend) {
        ...
        function assertNodeMatch(node, vnode) {
            if (vnode.tag) {
                return (
                    vnode.tag.indexOf('vue-dl-component') === 0 ||
        ...
        if (config.devtools) {
            if (devtools) {
                ...
                console.log(
                    ...
                    'https://github.com/vuejs/vue-dl-devtools'
                );
            }
        }
    }, 0);
